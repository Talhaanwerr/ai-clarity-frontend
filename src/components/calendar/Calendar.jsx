...
export default function Calendar() {
  ...
  return (
      <div className={'calendar-card rounded-t-2xl'}>
          <div className="lg:flex lg:h-full h-600 lg:flex-col rounded-t-2xl">
              <header className="flex items-center justify-between border-b rounded-t-2xl border-gray-200 px-6 py-4 lg:flex-none bg-gray-100">
